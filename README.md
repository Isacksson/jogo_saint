...
> **Nota de escopo:** o [`docs/GDD.md`](docs/GDD.md) foi expandido para a **v0.2** (mundo maior, peregrinação por regiões de superfície, lança Ascalon forjada por fragmentos, economia com ferreiro, editos de Diocleciano como relógio narrativo). Todo o conteúdo listado acima — Ato I e as 6 fossas — **continua válido e implementado**; o v0.2 o reaproveita e amplia. O roadmap renumerado (T12 = sistema de lança, T13 = economia, T14 = Estradas do Império, e assim por diante até T29) está na seção 6 do GDD. Próximo passo do plano v0.2: **T12 — Sistema de lança** (a lança de guarnição que evolui até Ascalon).
